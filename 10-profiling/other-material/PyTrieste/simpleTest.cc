...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>PyTrieste/valgrind/simpleTest.cc at master · thehackerwithin/PyTrieste</title>
...
<meta content="sb4I8giMsKqZFbYlFLEEsQSrL9bAOxBthTaY2OBFSqY=" name="csrf-token" />
    ...
    <link href="https://github.global.ssl.fastly.net/assets/github2-71386ba60dc4794e755db985b31f4dfc74dcd99d.css" media="all" rel="stylesheet" type="text/css" />
      ...
      <meta http-equiv="x-pjax-version" content="84e6805865ae35d7a55584163f2e8fe5">
        ...
        <link data-pjax-transient rel='permalink' href='/thehackerwithin/PyTrieste/blob/675c6cdb31e52dd9b2350e53043622da64bad5ee/valgrind/simpleTest.cc'>
...
<!-- blob contrib key: blob_contributors:v21:c6d515f06ed40e29813d5ba7f708f7cd -->
<!-- blob contrib frag key: views10/v8/blob_contributors:v21:c6d515f06ed40e29813d5ba7f708f7cd -->
    ...
    <div class="select-menu-modal">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/thehackerwithin/PyTrieste/blob/master/valgrind/simpleTest.cc" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="master" data-skip-pjax="true" rel="nofollow" title="master">master</a>
            </div> <!-- /.select-menu-item -->
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/thehackerwithin/PyTrieste/blob/solution/valgrind/simpleTest.cc" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="solution" data-skip-pjax="true" rel="nofollow" title="solution">solution</a>
            </div> <!-- /.select-menu-item -->
        </div>
      ...
      <div class="actions">
        <div class="button-group">
                <a class="minibutton tooltipped leftwards"
                   ...
                   href="/thehackerwithin/PyTrieste/edit/master/valgrind/simpleTest.cc"
                   data-method="post" rel="nofollow">Edit</a>
          <a href="/thehackerwithin/PyTrieste/raw/master/valgrind/simpleTest.cc" class="button minibutton " id="raw-url">Raw</a>
            <a href="/thehackerwithin/PyTrieste/blame/master/valgrind/simpleTest.cc" class="button minibutton ">Blame</a>
          <a href="/thehackerwithin/PyTrieste/commits/master/valgrind/simpleTest.cc" class="button minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->
            <a class="minibutton danger empty-icon tooltipped downwards"
               href="/thehackerwithin/PyTrieste/delete/master/valgrind/simpleTest.cc"
...
<span id="L20" rel="#L20">20</span>
          ...
          <td class="blob-line-code">
                  <div class="highlight"><pre><div class='line' id='LC1'><span class="cp">#include &lt;stdio.h&gt;</span></div><div class='line' id='LC2'><br/></div><div class='line' id='LC3'><span class="cm">/**</span></div><div class='line' id='LC4'><span class="cm">Borrows from </span></div><div class='line' id='LC5'><span class="cm">http://cs.ecs.baylor.edu/~donahoo/tools/valgrind/</span></div><div class='line' id='LC6'><span class="cm">*/</span></div><div class='line' id='LC7'><br/></div><div class='line' id='LC8'><span class="kt">int</span> <span class="nf">main</span><span class="p">()</span></div><div class='line' id='LC9'><span class="p">{</span></div><div class='line' id='LC10'>&nbsp;&nbsp;<span class="kt">char</span> <span class="o">*</span><span class="n">p</span><span class="p">;</span></div><div class='line' id='LC11'>&nbsp;&nbsp;<span class="kt">unsigned</span> <span class="kt">short</span> <span class="n">sz</span><span class="p">;</span></div><div class='line' id='LC12'>&nbsp;&nbsp;<span class="n">p</span> <span class="o">=</span> <span class="k">new</span> <span class="kt">char</span><span class="p">[</span><span class="n">sz</span><span class="p">];</span></div><div class='line' id='LC13'><br/></div><div class='line' id='LC14'>&nbsp;&nbsp;<span class="n">p</span> <span class="o">=</span> <span class="k">new</span> <span class="kt">char</span><span class="p">[</span><span class="mi">12</span><span class="p">];</span></div><div class='line' id='LC15'>&nbsp;&nbsp;<span class="k">delete</span><span class="p">(</span><span class="n">p</span><span class="p">);</span></div><div class='line' id='LC16'><br/></div><div class='line' id='LC17'>&nbsp;&nbsp;<span class="n">p</span> <span class="o">=</span> <span class="k">new</span> <span class="kt">char</span><span class="p">[</span><span class="mi">16</span><span class="p">];</span></div><div class='line' id='LC18'>&nbsp;&nbsp;<span class="n">printf</span><span class="p">(</span><span class="s">&quot;Size is %d&quot;</span><span class="p">,</span><span class="n">sz</span><span class="p">);</span></div><div class='line' id='LC19'>&nbsp;&nbsp;<span class="k">return</span> <span class="mi">0</span><span class="p">;</span></div><div class='line' id='LC20'><span class="p">}</span></div></pre></div>
          </td>
        </tr>
      </table>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2013 <span title="0.08814s from fe16.rs.github.com">GitHub</span>, Inc.</li>
